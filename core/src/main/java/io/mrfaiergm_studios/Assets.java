...
public class Assets {
    ...
    public static Texture basketUpgradeTexture4;
    public static Texture basketUpgradeTexture5;
    public static Texture basketUpgradeTexture6;
    public static Texture basketUpgradeTexture7;
    public static Texture basketUpgradeTexture8;
    ...
    public Assets(){
        ...
        basketUpgradeTexture4 = new Texture("Basket5.png");
        basketUpgradeTexture5 = new Texture("Basket6.png");
        basketUpgradeTexture6 = new Texture("Basket7.png");
        basketUpgradeTexture7 = new Texture("Basket8.png");
        basketUpgradeTexture8 = new Texture("Basket9.png");
    ...
    public void assetsDispouse(){
        ...
        basketUpgradeTexture4.dispose();
        basketUpgradeTexture5.dispose();
        basketUpgradeTexture6.dispose();
        basketUpgradeTexture7.dispose();
        basketUpgradeTexture8.dispose();
